 ...
 * 
 * import org.openqa.selenium.WebDriver; import org.testng.Reporter;
 * 
 * import com.test.helpers.Log; import com.test.pageobjects.HomePageObjects;
 * 
 ...
 * wait.until(ExpectedConditions .presenceOfElementLocated(HomePage.locator));
 * 
 * 
 * HomePage.calculatorsDropDown.click();
 * 
 ...
 * Thread.sleep(3000); HomePage.faqsDropDown.click();
 * 
 ...
 * Thread.sleep(3000); HomePage.mobilemenu.click();
 * 
 * Log.info("Click action is perfromed on faqs Link");
 * 
 * Reporter.log("Click action is perfromed on faqs Link");
